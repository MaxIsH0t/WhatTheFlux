package io.github.phantamanta44.wtflux.common.creativetab;
...
{
    public static final CustomCreativeTab MOD_TAB = new CustomCreativeTab(ModReference.MOD_ID + "moditems", false) {
        @Override
    ...
    public abstract static class CustomCreativeTab extends CreativeTabs
    {
        ...
        /**
         * gets the {@link ItemStack ItemStack} to display for the tab's icon
         */
